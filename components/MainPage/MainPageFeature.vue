  ...
  >
    ...
    >
      ...
      <v-card-subtitle
        ...
        class="py-0 font-weight-black caption text-uppercase pink--text text--darken-1"
      >
        <!-- Headlines -->
    ...
    <!-- <v-img
      ...
      height="400px"
      class="white--text align-end"
      src="https://sutvacha.s3.amazonaws.com/media/public/product/no-image-available.png"
      lazy-src="https://sutvacha.s3.amazonaws.com/media/public/product/no-image-available.png"
      aspect-ratio="1"
    /> -->
  </v-card>
</template>
